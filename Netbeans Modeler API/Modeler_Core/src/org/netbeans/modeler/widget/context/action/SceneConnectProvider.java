...
//        {
    ...
    public void createConnection(IModelerScene scene,
            INodeWidget source,
            INodeWidget target) //INodeWidget
    {
        ...
        if (target != null) {
            ...
            if (NBModelerUtil.isValidRelationship(file.getModelerDiagramModel().getRelationValidator(), source, target, edgeInfo.getType(), false) == false) {
//                edgeWidget.remove();
                return;
            }
...
//        List<INodeWidget> conn = new ArrayList<INodeWidget>();
//
//        if (getRelationshipFactory() != null)
//        {
//            INodeWidget rel = getRelationshipFactory().create(sourceElement.getFirstSubject(), targetElement.getFirstSubject());
//            if (rel == null)
//            {
//                return;
//            }
...
//            }
//
//            INodeWidget edge = createEdgePresentationElement(rel);
//            conn.add(edge);
//        }
//        else
//        {
...
//        }
//        HashSet < INodeWidget > selected = new HashSet < INodeWidget>(conn);
