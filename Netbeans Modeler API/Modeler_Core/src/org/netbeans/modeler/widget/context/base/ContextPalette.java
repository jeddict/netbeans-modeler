...
//import org.netbeans.modeler.widget.context.ui.ComboButton;
...
//    private Border RIGHT_BORDER = BorderFactory.createLineBorder(new Color(191, 208, 219));//(new GradientPaint(0,0,Color.LIGHT_GRAY,100, 0,Color.DARK_GRAY));//new EmptyBorder(5, 2, 5, 2);
//    private Border LEFT_BORDER = BorderFactory.createLineBorder(new Color(191, 208, 219));//( new GradientPaint(0,0,Color.DARK_GRAY,100, 0,Color.LIGHT_GRAY));//new EmptyBorder(5, 2, 5, 2);
//
//    public static final Color BACKGROUND = new Color(242, 249, 253);
//    public static final Color BORDER_COLOR = new Color(181, 198, 209);//new Color(181, 198 , 209);
//
...
////        g.drawRect(x, 0, collapsedSize.width - 1, collapsedSize.height - 1);
