...
//     * other node or edge in the model has is equal to this edge) and must not
//     * be a Widget
...
//     * already in the model, must be unique in the model (means: there is no
//     * other node or edge in the model has is equal to this node) and must not
//     * be a Widget
...
//     * nodes
//     */
//    Collection<E> findEdgesBetween(N sourceNode, N targetNode);
//
//    /**
...
//     * @param allowOutputEdges if true, the output edges are included in the
//     * collection; if false, the output edges are not included
//     * @param allowInputEdges if true, the input edges are included in the
//     * collection; if false, the input edges are not included
//     * @return the collection of edges
//     */
//    Collection<E> findNodeEdges(N node, boolean allowOutputEdges, boolean allowInputEdges);
//
//    /**
...
//     * @param sourceNode the source node; if null, then the edge source will be
//     * detached
//     */
//    void setEdgeSource(E edge, N sourceNode);
//
//    /**
//     * Sets an edge target.
//     *
//     * @param edge the edge which target is going to be changed
//     * @param targetNode the target node; if null, then the edge target will be
//     * detached
//     */
//    void setEdgeTarget(E edge, N targetNode);
