 ...
 * @author Gaurav Gupta
 */
public class PLightColorScheme implements IColorScheme {
    ...
    private static PLightColorScheme instance;

    public static PLightColorScheme getInstance() {
        if (instance == null) {
            synchronized (PLightColorScheme.class) {
                if (instance == null) {
                    instance = new PLightColorScheme();
                }
            }
        }
        return instance;
    ...
    private PLightColorScheme() {
        SCENE_BACKGROUND = new Color(255,255,255);
        ...
        WIDGET_BORDER = new ShadowBorder(new Color(213, 213, 213), 2, COLOR1, COLOR2, COLOR3, COLOR4, COLOR5);
        WIDGET_SELECT_BORDER = new ShadowBorder(new Color(200, 200, 200), 2, COLOR1, COLOR2, COLOR3, COLOR4, COLOR5);
        WIDGET_HOVER_BORDER = new ShadowBorder(new Color(180, 180, 180), 2, COLOR1, COLOR2, COLOR3, COLOR4, COLOR5);
    ...
    public void installUI(IPNodeWidget widget) {
        ...
        widget.getNodeNameWidget().setForeground(WIDGET_TEXT_COLOR);
