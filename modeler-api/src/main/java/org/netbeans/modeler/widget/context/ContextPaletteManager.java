...
public interface ContextPaletteManager {
     ...
     *
     * @param p point related to corresponding selection event in scene. If null
     * is specified the context palette manager will determine the best location
     * to place the palette.
     */
    public void selectionChanged(IWidget selectedWidget, Point p);
